...
// CODE HERE
const totalPopulation = populations.reduce(function(acc, num){
  return acc + num
})
console.log(totalPopulation)

//arrow const totalPopulation = pupulations.reduce((acc, num => acc + num))
...
const salesTaxAdded = orders.map(function(element){
  return element.price + element.tax
})
console.log(salesTaxAdded)
